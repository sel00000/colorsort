...
사용 목적은 cell을 현미경으로 사진을 찍고 나서 구분 짓는것은 시간이 굉장히 오래 걸린다 이를 해결 하기 위해 만들어진 tool 중에 하나 입ㄴ디ㅏ
생물학의 빠른 발전을 도모하고자 개발 되었습니다.

EMT score에 따른 cell에 형광 강도가 뚜렷하고 강하게 나타나는 이미지를 찾을 수있다 단, scroe 값은 측정하지 않고 파랑색, 초록색을 빠르게 구분 지어줍니다.
