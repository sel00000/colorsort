...
T = {
 "en": {
  ...
  "err.no_photos": "No photo files were found in this folder.\nSupported formats: PNG, JPG, JPEG, BMP, GIF, WEBP, TIFF\nSubfolders were searched too.",
  "err.all_excluded": "All {n} photos here are copies inside a previous results folder, so they were skipped.\nTry choosing a different folder.",
 ...
 "ko": {
  ...
  "err.no_photos": "이 폴더에서 사진 파일을 찾지 못했습니다.\n지원 형식: PNG · JPG · JPEG · BMP · GIF · WEBP · TIFF\n하위 폴더까지 함께 찾았습니다.",
  "err.all_excluded": "찾은 사진 {n}장이 모두 이전 결과 폴더의 사본이라 제외했습니다.\n다른 폴더를 선택해 보세요.",
